module Users::UserHelper
  def errors_by_accordion_type(user_errors)
    ...
    contact_info_errors << user_errors[:driver] if !user_errors[:driver].blank?
    contact_info_errors << user_errors[:rider] if !user_errors[:rider].blank?
