...
describe HookUpsHelper do
  ...
  describe '#activity_text' do
    ...
    it 'should return appropriate activity text for request' do
      ...
      helper.activity_text(@hook_up1, @user2).should == "#{@user1.try(:full_name)} offered a ride"
    end
    ...
    it 'should return appropriate activity text for offer' do
      ...
      helper.activity_text(@hook_up2, @user2).should == "#{@user1.try(:full_name)} requested a ride"
    end
  end
end
